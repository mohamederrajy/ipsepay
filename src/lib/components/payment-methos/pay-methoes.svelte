          ...
          <div class="relative">
            ...
            <div class="flex items-center gap-4 mb-8">
              <div class="p-4 rounded-2xl transition-all duration-500
                          {method.bgColor} {method.hoverBg} relative overflow-hidden
                          hover:scale-105 transform">
                <img 
                  src={method.icon} 
                  alt={method.name}
                  class="w-12 h-12 object-contain drop-shadow-lg transition-all duration-500
                         group-hover:scale-110 relative z-10"
                  loading="lazy"
                />
              </div>
              {#if method.additionalIcons}
                <div class="flex -space-x-4 animate-slide-in" style="animation-delay: {i * 300}ms">
