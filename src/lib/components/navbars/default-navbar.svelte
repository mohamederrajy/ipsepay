      ...
      <div class="hidden lg:block ms-auto">
        <ul class="navbar-nav flex gap-x-3 items-center justify-center">
          ...
          <li class="nav-item hs-dropdown relative inline-flex [--trigger:hover]">
            <a href="javascript:void(0);" id="hs-dropdown" class="nav-link after:absolute hover:after:-bottom-10 after:inset-0 hs-dropdown-toggle" data-fc-type="dropdown">
              Landing <i class="fa-solid fa-angle-down ms-2 align-middle"></i>
            </a>

            <div id="landingDropdownMenu" aria-labelledby="hs-dropdown" class="hs-dropdown-menu hs-dropdown-open:opacity-100 z-10 transition-[margin,opacity] duration-300 hidden mt-4 hs-dropdown-open:translate-y-0 translate-y-3 origin-center bg-white rounded-lg shadow-lg border p-2 w-96 grid grid-cols-2 gap-1.5">
              <div class="nav-item ">
                <a class="nav-link " href="/landing/app" class:active={routeTd === "/landing/app"}>
              ...
              <div class="nav-item">
                <a class="nav-link" href="/landing/saas" class:active={routeTd === "/landing/saas"}>
                  <div class="flex items-center -ms-1.5">
              ...
              <div class="nav-item">
                <a class="nav-link" href="/landing/saas2" class:active={routeTd === "/landing/saas2"}>
                  <div class="flex items-center -ms-1.5">
              ...
              <div class="nav-item">
                <a class="nav-link" href="/landing/startup" class:active={routeTd === "/landing/startup"}>
                  <div class="flex items-center -ms-1.5">
              ...
              <div class="nav-item">
                <a class="nav-link" href="/landing/software" class:active={routeTd === "/landing/software"}>
                  <div class="flex items-center -ms-1.5">
              ...
              <div class="nav-item">
                <a class="nav-link" href="/landing/agency" class:active={routeTd === "/landing/agency"}>
                  <div class="flex items-center -ms-1.5">
              ...
              <div class="nav-item">
                <a class="nav-link" href="/landing/coworking" class:active={routeTd === "/landing/coworking"}>
                  <div class="flex items-center -ms-1.5">
                    <span class="bg-primary/10 flex justify-center items-center w-8 h-8 shadow rounded me-3">
                      <svg class="text-primary w-6 h-6" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <div class="nav-item">
                <a class="nav-link" href="/landing/crypto" class:active={routeTd === "/landing/crypto"}>
                  <div class="flex items-center -ms-1.5">
                    <span class="bg-orange-600/10 flex justify-center items-center w-8 h-8 shadow rounded me-3">
                      <svg class="text-orange-600 w-6 h-6" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
              ...
              <div class="nav-item">
                <a class="nav-link" href="/landing/marketing" class:active={routeTd === "/landing/marketing"}>
                  <div class="flex items-center -ms-1.5">
              ...
              <div class="nav-item">
                <a class="nav-link" href="/landing/portfolio" class:active={routeTd === "/landing/portfolio"}>
                  <div class="flex items-center -ms-1.5">
          ...
          <li class="nav-item hs-dropdown relative inline-flex [--trigger:hover]">
            ...
            <div id="innerPageDropdownMenu" class="hs-dropdown-menu hs-dropdown-open:opacity-100 z-10 transition-[margin,opacity] duration-300 hidden mt-4 hs-dropdown-open:translate-y-0 translate-y-3 origin-center bg-white rounded-lg shadow-lg border p-2 w-48 space-y-1.5">
              ...
              <div class="nav-item hs-dropdown [--trigger:hover] [--placement:right-top]">
                <a class="nav-link after:absolute after:inset-0 after:-end-10 hs-dropdown-toggle" data-fc-type="dropdown" type="button">
                  Account <i class="fa-solid fa-angle-right ms-auto align-middle"></i>
                </a>

                <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 z-10 transition-[margin,opacity] duration-300 ms-2 hidden w-48 hs-dropdown-open:translate-y-0 translate-y-3 origin-center bg-white rounded-lg shadow-lg border p-2 space-y-1.5">
                  <div class="nav-item">
                  ...
                  <div class="nav-item">
                    <a class="nav-link" href="/account/forget-password">Forget Password</a>
                  </div>

                  <div class="nav-item">
                    <a class="nav-link" href="/account/confirm">Confirm Account</a>
                  </div>
                </div>
              </div>
              ...
              <!-- Dropdown item -->
              <div class="nav-item hs-dropdown [--trigger:hover] [--placement:right-top]">
                <a class="hs-dropdown-toggle nav-link after:absolute relative inline-flex" type="button">
                  Blog <i class="fa-solid fa-angle-right ms-auto align-middle"></i>
                </a>

                <div class="hs-dropdown-menu hs-dropdown-open:opacity-100 ms-2 hidden transition-[margin,opacity] w-48 hs-dropdown-open:translate-y-0 translate-y-3 origin-center bg-white rounded-lg shadow-lg border p-2 space-y-1.5">
                  <div class="nav-item">
                    <a class="nav-link" href="/blog" class:active={routeTd === "/blog"}>Blog</a>
                  </div>

                  <div class="nav-item">
                    <a class="nav-link" href="/blog/post" class:active={routeTd === "/blog/post"}>Blog Post</a>
                  </div>
                </div>
              </div>
              ...
              <!-- Dropdown item -->
              <div class="nav-item">
                <a class="nav-link" href="/company" class:active={routeTd === "/(pages)/company"}>Company</a>
              </div>

              <!-- Dropdown item -->
              <div class="nav-item">
                <a class="nav-link" href="/career" class:active={routeTd === "/(pages)/career"}>Career</a>
              </div>

              <!-- Dropdown item -->
              <div class="nav-item">
                <a class="nav-link" href="/pricing" class:active={routeTd === "/(pages)/pricing"}>Pricing</a>
              </div>

              <!-- Dropdown item -->
              <div class="nav-item hs-dropdown [--trigger:hover] [--placement:right-top]">
                <a class="nav-link after:absolute after:inset-0 after:-end-10 hs-dropdown-toggle" type="button">
                  Portfolio <i class="fa-solid fa-angle-right ms-auto align-middle"></i>
                </a>

                <div class="hs-dropdown-menu ms-2 hidden w-48 hs-dropdown-open:opacity-100 hs-dropdown-open:translate-y-0 translate-y-3 origin-center transition-[margin,opacity] bg-white rounded-lg shadow-lg border p-2 space-y-1.5">
                  <div class="nav-item">
                    <a class="nav-link" href="/portfolio/grid" class:active={routeTd === "/portfolio/grid"}>Portfolio Grid</a>
                  </div>

                  <div class="nav-item">
                    <a class="nav-link" href="/portfolio/masonry" class:active={routeTd === "/portfolio/masonry"}>Portfolio Masonry</a>
                  </div>

                  <div class="nav-item">
                    <a class="nav-link" href="/portfolio/item" class:active={routeTd === "/portfolio/item"}>Portfolio Item</a>
                  </div>
                </div>
              </div>
              ...
              <!-- Dropdown item -->
              <div class="nav-item">
                <a class="nav-link" href="/help" class:active={routeTd === "/(pages)/help"}>Help</a>
              </div>
            </div>
          </li>
...
<div id="mobileMenu" class="hs-overlay hs-overlay-open:translate-x-0 translate-x-full fixed top-0 end-0 transition-all duration-200 transform h-full w-full max-w-md z-[60] bg-white border-s hidden right-0">
  <div class="flex flex-col h-full divide-y-2 divide-gray-200">
    ...
    <div class="p-6 flex items-center justify-between">
      <a href="/">
        <img src="/images/logo-dark.png" class="h-8" alt="Logo" />
      </a>
      ...
      <ul class="navbar-nav flex flex-col gap-2" data-fc-type="accordion">
        ...
        <li class="nav-item">
          ...
          <ul id="hs-collapse-1" class="hs-collapse hidden overflow-hidden transition-[height] duration-300 space-y-2 w-full" aria-labelledby="hs-basic-collapse-1">
            <li class="nav-item mt-2">
              <a class="nav-link" href="/landing/app" class:active={routeTd === "/landing/app"}>App</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/landing/saas" class:active={routeTd === "/landing/saas"}>Saas Modern</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/landing/saas2" class:active={routeTd === "/landing/saas2"}>Saas Classic</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/landing/startup" class:active={routeTd === "/landing/startup"}>Startup</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/landing/software" class:active={routeTd === "/landing/software"}>Software</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/landing/agency" class:active={routeTd === "/landing/agency"}>Agency</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/landing/coworking" class:active={routeTd === "/landing/coworking"}>Coworking</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/landing/crypto" class:active={routeTd === "/landing/crypto"}>Crypto</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/landing/marketing" class:active={routeTd === "/landing/marketing"}>Marketing</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/landing/portfolio" class:active={routeTd === "/landing/portfolio"}>Portfolio</a>
            </li>
          </ul>
        </li>
        ...
        <li class="nav-item">
          ...
          <ul id="hs-collapse-2" class="hs-collapse hidden overflow-hidden transition-[height] duration-300 space-y-2 w-full" aria-labelledby="hs-basic-collapse-2">
            <li class="nav-item mt-2">
              <a class="nav-link" href="/company" class:active={routeTd === "/company"}>Company</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/career" class:active={routeTd === "/career"}>Career</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/pricing" class:active={routeTd === "/pricing"}>Pricing</a>
            </li>

            <li class="nav-item">
              <a class="nav-link" href="/help" class:active={routeTd === "/help"}>Help</a>
            </li>
          </ul>
        </li>
        ...
        <!-- Blog Page -->
        <li class="nav-item">
          <a href="javascript:void(0)" data-fc-type="collapse" class="nav-link hs-collapse-toggle" id="hs-basic-collapse-3" data-hs-collapse="#hs-collapse-3">
            Blog Page <i class="fa-solid fa-angle-down ms-auto align-middle transition-all hs-collapse-open:rotate-180"></i>
          </a>

          <ul id="hs-collapse-3" class="hs-collapse hidden overflow-hidden transition-[height] duration-300 space-y-2 w-full" aria-labelledby="hs-basic-collapse-3">
            <li class="nav-item mt-2">
              <a class="nav-link" href="/blog" class:active={routeTd === "/blog"}>Blog</a>
            </li>
        ...
        <!-- Portfolio Page -->
        <li class="nav-item">
          <a href="javascript:void(0)" data-fc-type="collapse" class="nav-link hs-collapse-toggle" id="hs-basic-collapse-4" data-hs-collapse="#hs-collapse-4">
            Portfolio <i class="fa-solid fa-angle-down ms-auto align-middle transition-all hs-collapse-open:rotate-180"></i>
          </a>

          <ul id="hs-collapse-4" class="hs-collapse hidden overflow-hidden transition-[height] duration-300 space-y-2 w-full" aria-labelledby="hs-basic-collapse-4">
            <li class="nav-item mt-2">
              <a class="nav-link" href="/portfolio/grid" class:active={routeTd === "/portfolio/grid"}>Portfolio Grid</a>
            </li>
            ...
            <li class="nav-item">
              <a class="nav-link" href="/account/confirm" class:active={routeTd === "/account/confirm"}>Confirm Account</a>
            </li>
          </ul>
        </li>
        ...
        <!-- Auth Page -->
        <li class="nav-item">
          <a href="javascript:void(0)" data-fc-type="collapse" class="nav-link hs-collapse-toggle" id="hs-basic-collapse-5" data-hs-collapse="#hs-collapse-5">
            Account <i class="fa-solid fa-angle-down ms-auto align-middle transition-all hs-collapse-open:rotate-180"></i>
          </a>

          <ul id="hs-collapse-5" class="hs-collapse hidden overflow-hidden transition-[height] duration-300 space-y-2 w-full" aria-labelledby="hs-basic-collapse-5">
            <li class="nav-item mt-2">
              <a class="nav-link" href="/account/login">Login</a>
            </li>
