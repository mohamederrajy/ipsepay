  ...
  <div class="container">
    <div class="lg:flex align-items-center">
      ...
      <div class="lg:w-5/12 ms-auto overflow-x-hidden">
        <div class="h-[520px]">
          <div id="marker-map5" class="h-100" data-toggle="map" data-map={{mapCenter: [40.749179, -73.989276], zoom: 12, useTextIcon: false, interactive: true, geojson: "//sample-listing-geojson.json"}}>
  ...
  <div class="container">
    <div class="grid md:grid-cols-3 grid-cols-1 gap-5">
      <div class="md:col-span-2">
        <div>
          <a href="index.html">
            <img src="/images/logo-dark.png" class="h-7" alt="" />
          </a>
          <p class="text-gray-500/80 mt-5 lg:w-1/2">On the other hand, we denounce with righteous indignation and dislike men who are so beguiled and demoralized.</p>
        </div>
      </div>
      <div class="grid grid-cols-2 gap-5">
        <div>
          <div class="flex flex-col gap-3">
            ...
            <div class="text-sm text-gray-500/80"><a href="javascript:void(0);">Blog</a></div>
            <div class="text-sm text-gray-500/80"><a href="javascript:void(0);">Faq</a></div>
            <div class="text-sm text-gray-500/80"><a href="javascript:void(0);">Team of Service</a></div>
            <div class="text-sm text-gray-500/80"><a href="javascript:void(0);">Privacy Policy</a></div>
          </div>
        </div>
        <div>
          <div class="flex flex-col gap-3">
            <h5 class="mb-3">Company</h5>
            <div class="text-sm text-gray-500/80"><a href="javascript:void(0);">About</a></div>
            <div class="text-sm text-gray-500/80"><a href="javascript:void(0);">Contact</a></div>
          </div>
        </div>
      </div>
    </div>
    ...
    <div class="grid sm:grid-cols-2 text-center sm:text-start gap-6">
      <div>
        <p class="text-gray-500/80 text-sm">
          {year} © Prompt. All rights reserved. Crafted by <a href="" class="text-gray-800 hover:text-primary transition-all">Coderthemes</a>
        </p>
      </div>
      <div class="flex justify-center sm:justify-end gap-7">
        <div>
          <a href="">
            <svg class="w-5 h-5 text-slate-500 hover:text-primary transition-all" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
