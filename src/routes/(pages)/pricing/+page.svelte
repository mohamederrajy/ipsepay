...
<section class="pt-36 pb-24 bg-slate-100">
  <div class="container">
    <div class="text-center max-w-2xl mx-auto">
      <h2 class="md:text-5xl/tight text-3xl font-semibold mb-5">Flexible plans that grow with you</h2>
      <p class="md:text-lg text-slate-500 leading-7">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit sed consequuntur ratione voluptatem sequi nesciunt.</p>
    </div>
  </div>
</section>
...
<section class="py-20">
  <div class="container">
    <div class="text-center max-w-2xl mx-auto">
      <span class="text-sm font-medium py-1 px-3 rounded-full text-primary bg-primary/10">Plans</span>
      <h2 class="md:text-3xl/tight text-3xl font-semibold my-4">Pricing Plans</h2>
      <p class="md:text-lg text-slate-500 leading-7">Pricing that <span class="text-primary">works</span> for everyone.</p>
    </div>
    ...
    <div class="grid xl:grid-cols-3 lg:grid-cols-2 grid-cols-1 gap-6 items-center mt-16">
      <div>
        <div class="border p-6 text-center rounded hover:shadow-lg">
          <h4 class="text-lg text-primary">Starter</h4>
          <h1 class="mt-3 mb-8">
            <sup class="align-super text-sm text-slate-500">$</sup>
            <span class="text-3xl font-semibold">49</span>
            <sub class="text-sm text-slate-500">/ month</sub>
          </h1>
          <hr />
          <div class="grid gap-y-4 mt-8">
            <div class="flex items-center gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="w-5 h-5 text-green-500 feather feather-check align-middle icon-dual-success me-2 icon-xs">
          ...
          <div class="mt-24">
            <a href="" class="py-3 px-6 flex items-center justify-center rounded hover:border hover:border-primary/50 text-primary bg-primary/10 transition-all duration-500">Sign Up Now</a>
          </div>
        </div>
      </div>
      ...
      <div>
        <div class="border p-6 rounded hover:shadow-lg relative">
          <div class="absolute w-full h-[188px] -z-10 top-0 left-0 overflow-hidden">
            <span class="absolute transform rotate-45 bg-primary text-center text-white font-medium py-1 right-[-52px] top-[23px] w-[170px] h-5 z-[2] text-xs overflow-hidden border border-dashed leading-[8px] border-white shadow-[0_0_0_3px] shadow-primary/40">Popular</span>
          </div>
          <h4 class="text-lg text-primary text-center">Professional</h4>
      ...
      <div>
        <div class="border p-6 rounded hover:shadow-lg">
          <h4 class="text-lg text-primary text-center">Enterprise</h4>
          <h1 class="mt-3 mb-8 text-center">
            <sup class="align-super text-sm text-slate-500">$</sup>
...
<section class="py-20">
  <div class="container">
    <div class="text-center max-w-2xl mx-auto">
      ...
      <h2 class="md:text-3xl/tight text-3xl font-semibold my-4">All plans includes these benefits</h2>
      <p class="md:text-lg text-slate-500 leading-7">Some benefits of the monthly/yearly subscription</p>
    </div>
    ...
    <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 gap-y-10 mt-16">
      <div>
        <div class="flex items-center lg:justify-center gap-6">
          ...
          <div>
            <h5 class="text-base">Technical Support</h5>
            <p class="text-slate-400 mt-2">Our professional technical support team will help you out at every step</p>
          </div>
        </div>
      </div>
      ...
      <div>
        <div class="flex items-center lg:justify-center gap-6">
          ...
          <div>
            <h5 class="text-base">Technology</h5>
            <p class="text-slate-400 mt-2">A special training to get start with the platform by professionals</p>
          </div>
        </div>
      </div>
      ...
      <div>
        <div class="flex items-center lg:justify-center gap-6">
          ...
          <div>
            <h5 class="text-base">Growth Analysis</h5>
            <p class="text-slate-400 mt-2">A dedicated team to get insights around your growth every month</p>
          </div>
        </div>
      </div>
      ...
      <div>
        <div class="flex items-center lg:justify-center gap-6">
          ...
          <div>
            <h5 class="text-base">Rewards</h5>
            <p class="text-slate-400 mt-2">A special reward for the most performing account every month</p>
          </div>
        </div>
      </div>
    </div>
