<script lang="ts">
  ...
  import AppHero from "$lib/components/heros/app-hero.svelte";
  import Testimonial1 from "$lib/components/testimonials/testimonial-1.svelte";
  import AppFooter from "$lib/components/footers/app-footer.svelte";
</script>
...
<section class="py-20">
  <div class="container">
    <div class="text-center">
      ...
      <p class="text-slate-500">Start working with <span class="text-primary">Prompt</span> to showcase your app to thousands of people.</p>
    </div>
    ...
    <div class="grid lg:grid-cols-3 grid-cols-1 items-center gap-6 mt-5">
      <div class="relative">
        ...
        <img src="/images/features/app2.png" class="lg:w-full w-1/2 mx-auto" data-aos="zoom-in-right" />
      </div>
      ...
      <div class="lg:col-span-2">
        <div class="grid sm:grid-cols-2 grid-cols-1 gap-7 lg:ps-32">
          <div>
            ...
            <p class="text-slate-500">We use a customized application tobe specifically designed a testing gnose to keep away for people.</p>
          </div>
          ...
          <div>
            ...
            <p class="text-slate-500">In order to design a mobile app that is going to be module downloaded and accessed frequently by users.</p>
          </div>
          ...
          <div>
            ...
            <p class="text-slate-500">A Private Limited is the most popular type of partnership Malta. The limited liabilityis</p>
          </div>
          ...
          <div>
            ...
            <p class="text-slate-500">Few derived into talking being in merit long you'd his the of to had the to duties, it them one...</p>
          </div>
        </div>
      </div>
    </div>
  ...
  <div class="container">
    ...
    <div class="grid lg:grid-cols-3 grid-cols-1 gap-6 mt-16">
      <div class="text-center relative" data-aos="fade-up" data-aos-duration="300">
        ...
        <p class="mt-3">Save time and edit like a pro! Yes! you will be able to edit your application on the easy way.</p>
        <div class="pt-5">
          <img src="/images/features/app4.png" />
        </div>
      ...
      <div class="text-center relative" data-aos="fade-up" data-aos-duration="300">
        ...
        <p class="mt-3">Speedy App provides instant information on whit thousands of hire and buy products.</p>
        <div class="pt-5">
          <img src="/images/features/app3.png" />
        </div>
