<script lang="ts">
  ...
  import MarketingHero from "$lib/components/heros/marketing-hero.svelte";
  import Testimonial4 from "$lib/components/testimonials/testimonial-4.svelte";
  import MarketingFooter from "$lib/components/footers/marketing-footer.svelte";
</script>

<PageTitle title="Marketing Landing Page" />
  ...
  <div class="py-10">
    <div class="container">
      <div class="text-center">
        ...
        <p class="text-gray-500">Start working with <span class="text-primary"> Prompt</span> to manage your marketing better.</p>
      </div>
      ...
      <div class="grid lg:grid-cols-3 lg:gap-6 gap-10 mt-16">
        <div data-aos="fade-up" data-aos-duration="300">
          <div class="h-12 w-12 rounded-md bg-blue-500/10 flex items-center justify-center">
            <svg class="h-7 w-7 text-blue-500" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <p class="text-gray-500">Praesent ipsum libero, sollicitudin elementum et, condimentum non augue.</p>
        </div>

        <div data-aos="fade-up" data-aos-duration="600">
          <div class="h-12 w-12 rounded-md bg-red-500/10 flex items-center justify-center">
            <svg class="h-7 w-7 text-red-500" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <rect id="bound" x="0" y="0" width="24" height="24"></rect>
                ...
                <path d="M8.7295372,14.6839411 C8.35180695,15.0868534 7.71897114,15.1072675 7.31605887,14.7295372 C6.9131466,14.3518069 6.89273254,13.7189711 7.2704628,13.3160589 L11.0204628,9.31605887 C11.3857725,8.92639521 11.9928179,8.89260288 12.3991193,9.23931335 L15.358855,11.7649545 L19.2151172,6.88035571 C19.5573373,6.44687693 20.1861655,6.37289714 20.6196443,6.71511723 C21.0531231,7.05733733 21.1271029,7.68616551 20.7848828,8.11964429 L16.2848828,13.8196443 C15.9333973,14.2648593 15.2823707,14.3288915 14.8508807,13.9606866 L11.8268294,11.3801628 L8.7295372,14.6839411 Z" id="Path-97" fill="currentColor" opacity="0.3"></path>
              </g>
            </svg>
          </div>
          <h1 class="mb-3 mt-4 text-lg">Business Analytics</h1>
          <p class="text-gray-500">Mauris dapibus blandit hendrerit. Proin auctor est at bibendum faucibus sodales.</p>
        </div>

        <div data-aos="fade-up" data-aos-duration="900">
          <div class="h-12 w-12 rounded-md bg-teal-500/10 flex items-center justify-center">
            <svg class="h-7 w-7 text-teal-500" viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                <rect id="bound" x="0" y="0" width="24" height="24"></rect>
      ...
      <div class="relative">
        <div class="lg:absolute lg:max-w-md lg:translate-y-1/2 z-10 mb-14">
          <div class="bg-white shadow-lg border rounded-lg p-4 w-full">
            <div class="relative">
              <div class="before:w-20 before:h-20 before:absolute before:-bottom-12 before:-start-12 before:-z-10 before:bg-[url('../images/pattern/dot2.svg')] hidden sm:block"></div>
              ...
              <p class="text-gray-500">Et harum quidem rerum facilis est et expedita distinctio at libero tempore cum soluta nobis est eligendi optio cumque.</p>
        ...
        <div class="relative">
          <img src="/images/features/marketing.jpg" class="ms-auto rounded" />
          <div class="after:w-20 after:h-20 after:absolute after:-top-8 after:-end-8 after:-z-10 after:bg-[url('../images/pattern/dot5.svg')] hidden sm:block"></div>
        </div>
      </div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="grid lg:grid-cols-3 grid-cols-1 gap-10 items-center" data-aos="fade-up">
        <div class="lg:col-span-2">
          ...
          <p class="text-gray-500">Aenean sagittis tellus lacus, nec aliquet mi gravida at. Aenean velit purus, consectetur ut lobortis ac, dignissim id mi.</p>
          <div class="mt-5 flex items-center">
            <a href="" class="text-primary text-sm">Learn more <i class="fa-solid fa-arrow-right ms-2"></i></a>
          </div>
        </div>
          ...
          <div class="bg-white shadow-lg border rounded-lg p-10 lg:w-full md:w-1/2 sm:w-3/4 w-full">
            <div class="flex flex-col gap-5">
              <h6 class="flex items-center gap-3 font-medium text-sm">
                <svg class="h-5 w-5 text-green-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  ...
  <div class="container">
    <div class="grid lg:grid-cols-2 grid-cols-1 gap-14 items-center" data-aos="fade-up">
      <div class="order-2 lg:order-1">
        ...
        <p class="text-gray-500">Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et voluptates repudiandae sint et molestiae non recusandae itaque earum rerum hic tenetur a sapiente delectus ut aut reiciendis voluptatibus maiores alias...</p>
        <div>
          <button for="Email" class="bg-primary text-white rounded-lg text-sm font-semibold flex-none shadow-lg shadow-primary/30 focus:shadow-none focus:outline focus:outline-primary/40 px-8 py-3 mt-8"> Start Free Trial <i class="fa-solid fa-arrow-right"></i></button>
        </div>
      </div>

      <div class="order-1 lg:order-2">
        <img src="/images/features/marketing4.jpg" alt="marketing4" class="shadow" />
      </div>
    </div>
  </div>
</section>
