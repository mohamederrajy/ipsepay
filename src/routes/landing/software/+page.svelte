<script lang="ts">
  ...
  import SoftwareHero from "$lib/components/heros/software-hero.svelte";
  import Pricing2 from "$lib/components/pricing-2.svelte";
  import Testimonial1 from "$lib/components/testimonials/testimonial-1.svelte";
  import SoftwareFooter from "$lib/components/footers/software-footer.svelte";
</script>

<PageTitle title="Software Landing Page" />
...
<section class="py-16">
  <div class="container">
    <div class="grid xl:grid-cols-2 grid-cols-1 items-center">
      <div>
        <p class="text-base font-medium">Join 10,000+ other companies who are using Prompt</p>
        <div class="flex flex-wrap md:flex-nowrap gap-10 mt-7">
          <div>
            <img src="/images/brands/amazon.svg" class="w-28" />
          </div>
          <div>
            <img src="/images/brands/google.svg" class="w-28" />
          </div>
          <div>
            <img src="/images/brands/paypal.svg" class="w-28" />
          </div>
          <div>
            <img src="/images/brands/spotify.svg" class="w-28" />
          </div>
          <div>
            <img src="/images/brands/shopify.svg" class="w-28" />
          </div>
        </div>
      </div>
      ...
      <div>
        <div class="flex xl:justify-end items-center mt-7">
          <div class="flex items-center">
            ...
            <img src="/images/brands/mr.svg" class="w-12 h-8" />
          </div>
        </div>
...
<section class="py-16 sm:py-24">
  <div class="container">
    <div>
      <div class="grid lg:grid-cols-2 grid-cols-1 2xl:gap-24 gap-10 items-center">
        <div class="order-2 lg:order-1" data-aos="fade-right" data-aos-duration="600">
          ...
          <h1 class="text-3xl/tight font-medium mt-3 mb-4">Smart auto deployment</h1>
          <p class="text-gray-500">Prompts automatically deploys your changes on the cloud</p>
        ...
        <div class="order-1 lg:order-2" data-aos="fade-left" data-aos-duration="700">
          <img src="/images/features/desktop1.gif" />
        </div>
      </div>
    </div>
    ...
    <div class="py-16 sm:py-24">
      <div class="grid lg:grid-cols-2 grid-cols-1 2xl:gap-24 gap-10 items-center">
        <div>
          <img src="/images/hero/desktop.png" data-aos="fade-right" data-aos-duration="600" />
        </div>

        <div data-aos="fade-left" data-aos-duration="700">
          <span class="text-sm bg-red-500/10 text-red-600 rounded-full px-3 py-1">Auto Sync</span>
          <h1 class="text-3xl/tight font-medium mt-3 mb-4">AutoSync deployment</h1>
          <p class="text-gray-500">Prompts automatically sync your scheduled sync configuration</p>
          ...
          <div class="flex flex-col gap-4 mt-10">
            ...
            <div class="flex items-center gap-4">
              ...
              <h1 class="font-medium">A powerful command line interface</h1>
            </div>
          </div>
        </div>
      </div>
