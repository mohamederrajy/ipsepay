...
<section class="pt-36 pb-24 bg-slate-100">
    <div class="container">
        <div class="text-center max-w-2xl mx-auto">
            <h2 class="md:text-5xl/tight text-3xl font-semibold mb-5">Portfolio Grid</h2>
            <p class="lg:text-lg text-slate-500 leading-7">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut
        ...
        <div id="gallery-wrapper" class="md:flex justify-center mx-auto mt-6">
                ...
                <div>
                    <div class="border p-2 rounded shadow">
                        <div class="overflow-hidden">
                            <a class="image-popup" href="/images/photos/1.jpg">
            ...
            <div class="lg:w-1/3 md:w-1/2 p-2 picture-item" data-groups="['graphic-design']">
                <div>
                    <div class="border p-2 rounded shadow">
                        <div class="overflow-hidden">
                            <a class="image-popup" href="/images/photos/7.jpg">
            ...
            <div class="lg:w-1/3 md:w-1/2 p-2 picture-item" data-groups="['photography','web-design']">
                <div>
                    <div class="border p-2 rounded shadow">
                        <div class="overflow-hidden">
