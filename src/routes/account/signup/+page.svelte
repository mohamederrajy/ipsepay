  ...
  <div class="container">
    <div>
          ...
          <div class="bg-white shadow-md p-12 rounded-s xl:col-span-5 md:col-span-6">
            ...
            <form action="#">
              <div class="mb-4">
                ...
                <input type="text" id="input-label" class="py-2 px-4 leading-6 block w-full border-gray-300 rounded text-sm focus:border-gray-300 focus:ring-0" placeholder="Your Name" />
              </div>
      ...
      <div class="w-full text-center">
        <p class="text-gray-500 leading-6 text-base">Already have an account? <a href="/account/login" class="text-primary font-semibold ms-1">Log In</a></p>
      </div>
    </div>
  </div>
</div>
