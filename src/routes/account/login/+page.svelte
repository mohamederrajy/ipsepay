<script lang="ts">
  ...
  onMount(() => {
    document.getElementsByTagName("body")[0].classList.add("bg-slate-100", "tracking-wide");
  });
</script>
  ...
  <div class="container">
    <div>
      <div class="bg-white shadow rounded mb-6">
        <div class="grid md:grid-cols-12">
          <div class="bg-white shadow-md p-12 rounded-s xl:col-span-5 md:col-span-6">
            ...
            <form action="#">
              <div class="mb-4">
                <label for="email" class="block text-sm font-medium mb-1 text-gray-600"
                  >Email
                  <small>*</small></label
                >
              ...
              <div class="mb-4">
                <a href="/account/forget-password" class="float-right text-gray-500 text-xs border-b border-dashed pb-1 ms-1">Forgot your password?</a>
                <label for="password" class="block text-sm font-medium mb-1 text-gray-600"
                  >Password
                  <small>*</small></label
                >
                  ...
                  <div class="swiper" id="swiper_one">
                    <div class="swiper-wrapper">
                      <div class="swiper-slide">
                        <div class="swiper-slide-content">
                          <div class="text-center w-3/5 mx-auto">
                            <img src="/images/hero/saas1.png" class="w-full" />
                          </div>
                          <div class="text-center my-6 pb-12">
                            ...
                            <p class="text-sm/[1.6] text-gray-500 mb-4">Make your saas application stand out with high-quality landing page designed and developed by professional.</p>
                          </div>
                        </div>
                      </div>
                      <!-- swiper-slide End -->
                      <div class="swiper-slide">
                        <div class="swiper-slide-content">
                          <div class="text-center w-3/5 mx-auto">
                            <img src="/images/hero/saas2.png" class="w-full" />
                          </div>
                          <div class="text-center my-6 pb-12">
                            <h5 class="font-medium text-base/[1.6] text-gray-600 my-2.5">The best way to showcase your mobile app</h5>
                            <p class="text-sm/[1.6] text-gray-500">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium.</p>
                          </div>
                        </div>
                      </div>
                      <!-- swiper-slide End -->
                      <div class="swiper-slide">
                        <div class="swiper-slide-content">
                          <div class="text-center w-3/5 mx-auto">
                            <img src="/images/hero/saas3.png" class="w-full" />
                          </div>
                          <div class="text-center my-6 pb-12">
      ...
      <div class="w-full text-center">
        <p class="text-gray-500 leading-6 text-base">Don't have an account? <a href="/account/signup" class="text-primary font-semibold ms-1">Sign Up</a></p>
      </div>
    </div>
  </div>
</div>
