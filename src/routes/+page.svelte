<script lang="ts">
    ...
    import  Pricing from "$lib/components/pricing /prcing.svelte";
    import BusinessCategores from "$lib/components/business-categores/business-categores.svelte";
    import Advantages from "$lib/components/advantages/advantages.svelte";
    import CtaSection from "$lib/components/section-find-more/cta-section.svelte";
    import Integration from "$lib/components/integration/integration.svelte";
    import ScrollingImages from "$lib/components/scrolling-images/scrolling-images.svelte";
          ...
          <div class="grid lg:grid-cols-2 grid-cols-1 gap-6 items-center">
            <div class="relative">
              <div class="hidden sm:block">
                <div class="after:w-20 after:h-20 after:absolute after:-top-8 after:-start-8 2xl:after:end-0 after:bg-[url('../images/pattern/dot5.svg')]"></div>
                <div class="before:w-20 before:h-20 before:absolute before:-bottom-8 before:-end-8 before:bg-[url('../images/pattern/dot2.svg')]"></div>
              </div>
              <img src="/images/hero/saas1.png" alt="saas1" data-aos="fade-right" data-aos-duration="400" />
            </div>
            ...
            <div class="lg:ms-24">
              <div data-fc-type="accordion" data-aos="fade-up" data-aos-duration="500">
                ...
                <div class="w-full overflow-hidden duration-300 ps-16">
                  <p class="text-gray-700 dark:text-gray-300">Before we dive into why companies must invest in employee experience (EX), it’s important to understand what this concept entails.</p>
                  <div class="mt-7 flex items-center">
                    <a href="" class="text-primary">Sing up now <i class="fa-solid fa-arrow-right ms-2"></i></a>
                  </div>
                </div>
                ...
                <div class="hidden w-full overflow-hidden duration-300 ps-16">
                  <p class="text-gray-700 dark:text-gray-300">Post your job, interview candidates and make offers, all on Prompt. Start hiring today.</p>
                  <div class="mt-7 flex items-center">
                ...
                <div class="hidden w-full overflow-hidden duration-300 ps-16">
                  <p class="text-gray-700 dark:text-gray-300">Finding committed employees is one of public and private organizations’ top priorities.</p>
                  <div class="mt-7 flex items-center">
                    <a href="" class="text-primary">Learn more <i class="fa-solid fa-arrow-right ms-2"></i></a>
                  </div>
                </div>
        ...
        <div>
          <div class="grid lg:grid-cols-2 grid-cols-1n gap-6 items-center">
            ...
            <div class="relative order-1 lg:order-2">
              <div class="hidden sm:block">
                <div class="after:w-20 after:h-20 after:absolute after:-top-8 after:-end-8 2xl:after:-end-8 after:bg-[url('../images/pattern/dot2.svg')]"></div>
                <div class="before:w-20 before:h-20 before:absolute before:-bottom-8 before:-start-8 before:bg-[url('../images/pattern/dot5.svg')]"></div>
              </div>
  
              <img src="/images/hero/saas2.png" alt="saas2" data-aos="fade-left" data-aos-duration="400" />
            </div>
          </div>
        </div>
      </div>
